...
export default class HomeScreen extends Component {
    ...
    render() {
        ...
        if (!load) {
            return <View style={{flex: 1, backgroundColor: '#21232a', justifyContent:'center', alignItems: 'center'}}>
                ...
                <SafeAreaView style={{flex: 1, backgroundColor: '#21232a'}}>
                    <KeyboardAwareScrollView
                        ...
                        <View style={styles.body}>
                            ...
                            {(select !== null && code !== '') && <Button style={{width: '60%', alignSelf: 'center'}} onPress={this.onCompleteHandler}>
                                {completeLoader ?
